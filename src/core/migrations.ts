 ...
 *
 * This is the canonical source for migrations, used by both CLI and Electron.
 * IMPORTANT: Keep this file in sync with src/main/database-migrations.ts
 */
...
export const migrations: Migration[] = [
  ...
  // Keep this file in sync with src/main/database-migrations.ts
  {
    version: 18,
