...
/**
 * Project and Settings database operations
 */
export class ProjectOperations {
  ...
  updateProject(id: string, updates: Partial<Pick<Project, 'name' | 'goal' | 'constraints' | 'custom_agents' | 'review_mode'>>): Project | undefined {
    const sets: string[] = []
